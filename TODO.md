...
Current campaign state (2026-09-17): **1,272** stable work units total; **801**
completed (**717** retained/reviewed units and **84** source-retirement units),
**471** pending; **5,027** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0080`.
