...
Current campaign state (2026-09-16): **1,272** stable work units total; **260**
completed (**242** retained/reviewed units and **18** source-retirement units),
**1,012** pending; **2,194** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0025`.
