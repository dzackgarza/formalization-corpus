...
Current campaign state (2026-09-17): **1,272** stable work units total; **1,093**
completed (**975** retained/reviewed units and **118** source-retirement units),
**179** pending; **6,833** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0107`.
