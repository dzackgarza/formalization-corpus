...
Current campaign state (2026-09-16): **1,272** stable work units total; **477**
completed (**450** retained/reviewed units and **27** source-retirement units),
**795** pending; **3,876** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0047`.
