...
Current campaign state (2026-09-17): **1,272** stable work units total; **741**
completed (**659** retained/reviewed units and **82** source-retirement units),
**531** pending; **4,009** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0072`.
