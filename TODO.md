...
Current campaign state (2026-09-16): **1,272** stable work units total; **439**
completed (**412** retained/reviewed units and **27** source-retirement units),
**833** pending; **3,189** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0043`.
