...
Current campaign state (2026-09-16): **1,272** stable work units total; **468**
completed (**441** retained/reviewed units and **27** source-retirement units),
**804** pending; **3,663** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0046`.
