...
Current campaign state (2026-09-17): **1,272** stable work units total; **831**
completed (**745** retained/reviewed units and **86** source-retirement units),
**441** pending; **5,041** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0083`.
