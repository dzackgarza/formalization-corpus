...
Current campaign state (2026-09-16): **1,272** stable work units total; **364**
completed (**337** retained/reviewed units and **27** source-retirement units),
**908** pending; **2,281** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0035`.
