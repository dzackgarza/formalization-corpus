...
Current campaign state (2026-09-16): **1,272** stable work units total; **623**
completed (**558** retained/reviewed units and **65** source-retirement units),
**649** pending; **3,999** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0062`.
