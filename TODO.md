...
Current campaign state (2026-09-16): **1,272** stable work units total; **388**
completed (**361** retained/reviewed units and **27** source-retirement units),
**884** pending; **2,282** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0037`.
