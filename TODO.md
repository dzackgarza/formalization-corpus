...
Current campaign state (2026-09-16): **1,272** stable work units total; **200**
completed (**189** retained/reviewed units and **11** source-retirement units),
**1,072** pending; **2,132** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0020`.
