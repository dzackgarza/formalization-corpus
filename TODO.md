...
Current campaign state (2026-09-17): **1,272** stable work units total; **1,229**
completed (**1,102** retained/reviewed units and **127** source-retirement units),
**43** pending; **6,908** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0119`.
