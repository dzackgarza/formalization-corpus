...
Current campaign state (2026-09-16): **1,272** stable work units total; **415**
completed (**388** retained/reviewed units and **27** source-retirement units),
**857** pending; **2,542** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0040`.
