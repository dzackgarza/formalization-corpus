...
Current campaign state (2026-09-16): **1,272** stable work units total; **357**
completed (**330** retained/reviewed units and **27** source-retirement units),
**915** pending; **2,278** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0034`.
