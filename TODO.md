...
Current campaign state (2026-09-16): **1,272** stable work units total; **212**
completed (**201** retained/reviewed units and **11** source-retirement units),
**1,060** pending; **2,137** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0021`.
