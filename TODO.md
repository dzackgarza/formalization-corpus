...
Current campaign state (2026-09-17): **1,272** stable work units total; **753**
completed (**669** retained/reviewed units and **84** source-retirement units),
**519** pending; **4,009** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0073`.
