...
Current campaign state (2026-09-17): **1,272** stable work units total; **985**
completed (**874** retained/reviewed units and **111** source-retirement units),
**287** pending; **6,459** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0097`.
