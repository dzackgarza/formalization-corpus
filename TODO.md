...
Current campaign state (2026-09-17): **1,272** stable work units total; **1,141**
completed (**1,016** retained/reviewed units and **125** source-retirement units),
**131** pending; **6,833** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0111`.
