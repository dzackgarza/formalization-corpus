...
Current campaign state (2026-09-17): **1,272** stable work units total; **819**
completed (**735** retained/reviewed units and **84** source-retirement units),
**453** pending; **5,034** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0082`.
