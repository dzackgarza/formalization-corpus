...
Current campaign state (2026-09-17): **1,272** stable work units total; **913**
completed (**817** retained/reviewed units and **96** source-retirement units),
**359** pending; **5,045** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0091`.
