...
Current campaign state (2026-09-17): **1,272** stable work units total; **1,185**
completed (**1,058** retained/reviewed units and **127** source-retirement units),
**87** pending; **6,860** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0115`.
