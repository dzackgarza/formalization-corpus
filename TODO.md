...
Current campaign state (2026-09-16): **1,272** stable work units total; **248**
completed (**235** retained/reviewed units and **13** source-retirement units),
**1,024** pending; **2,179** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0024`.
