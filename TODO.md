...
Current campaign state (2026-09-17): **1,272** stable work units total; **925**
completed (**823** retained/reviewed units and **102** source-retirement units),
**347** pending; **5,045** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0092`.
