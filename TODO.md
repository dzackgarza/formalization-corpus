...
Current campaign state (2026-09-17): **1,272** stable work units total; **798**
completed (**714** retained/reviewed units and **84** source-retirement units),
**474** pending; **5,027** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0079`.
