...
Current campaign state (2026-09-16): **1,272** stable work units total; **635**
completed (**568** retained/reviewed units and **67** source-retirement units),
**637** pending; **3,999** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0063`.
