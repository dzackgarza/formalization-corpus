...
Current campaign state (2026-09-17): **1,272** stable work units total; **729**
completed (**647** retained/reviewed units and **82** source-retirement units),
**543** pending; **4,008** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0071`.
