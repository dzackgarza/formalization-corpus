...
Current campaign state (2026-09-16): **1,272** stable work units total; **320**
completed (**295** retained/reviewed units and **25** source-retirement units),
**952** pending; **2,222** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0030`.
