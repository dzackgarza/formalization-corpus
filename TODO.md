...
Current campaign state (2026-09-16): **1,272** stable work units total; **647**
completed (**577** retained/reviewed units and **70** source-retirement units),
**625** pending; **3,999** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0064`.
