...
Current campaign state (2026-09-17): **1,272** stable work units total; **973**
completed (**862** retained/reviewed units and **111** source-retirement units),
**299** pending; **6,459** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0096`.
