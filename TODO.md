...
Current campaign state (2026-09-16): **1,272** stable work units total; **587**
completed (**528** retained/reviewed units and **59** source-retirement units),
**685** pending; **3,999** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0059`.
