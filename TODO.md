...
Current campaign state (2026-09-17): **1,272** stable work units total; **1,197**
completed (**1,070** retained/reviewed units and **127** source-retirement units),
**75** pending; **6,873** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0116`.
