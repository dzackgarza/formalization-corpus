...
Current campaign state (2026-09-17): **1,272** stable work units total; **937**
completed (**835** retained/reviewed units and **102** source-retirement units),
**335** pending; **5,046** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0093`.
