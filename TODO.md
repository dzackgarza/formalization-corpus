...
Current campaign state (2026-09-17): **1,272** stable work units total; **867**
completed (**776** retained/reviewed units and **91** source-retirement units),
**405** pending; **5,045** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0086`.
