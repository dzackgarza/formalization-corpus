...
Current campaign state (2026-09-16): **1,272** stable work units total; **418**
completed (**391** retained/reviewed units and **27** source-retirement units),
**854** pending; **2,868** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0041`.
