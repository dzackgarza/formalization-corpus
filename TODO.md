...
Current campaign state (2026-09-16): **1,272** stable work units total; **308**
completed (**285** retained/reviewed units and **23** source-retirement units),
**964** pending; **2,216** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0029`.
