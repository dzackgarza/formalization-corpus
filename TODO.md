...
Current campaign state (2026-09-16): **1,272** stable work units total; **430**
completed (**403** retained/reviewed units and **27** source-retirement units),
**842** pending; **2,996** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0042`.
