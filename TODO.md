...
Current campaign state (2026-09-16): **1,272** stable work units total; **527**
completed (**493** retained/reviewed units and **34** source-retirement units),
**745** pending; **3,999** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0054`.
