...
Current campaign state (2026-09-17): **1,272** stable work units total; **807**
completed (**723** retained/reviewed units and **84** source-retirement units),
**465** pending; **5,028** exact repository-local FD-018 exclusions.  The next
repository-review frontier is `RRB-0081`.
